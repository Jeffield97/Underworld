...
local DxData = {
	font = dxCreateFont('files/font/font.ttf', 13, false);
	fontScale = false,
	colorData = {0,176,255},
	loginX = sX*0.6,
	loginTick = 0,
	...
	if #Notifications ~= 0 then
		...
		repeat
			...
			if drawThis then
				...
				posY = mData[6]
				alpha = 255
				dxDrawImage(posX,posY,mData[4],sY*0.025,"files/img/dx.png",0,0,0,tocolor(255,255,255,alpha*0.95));
				dxDrawImage(posX+mData[4]-20,posY,sX*0.015,sY*0.025,"files/img/dx.png",0,0,0,tocolor(0,0,0,0));
				if mData[2] == "error" then
				dxDrawImage(posX+mData[4]-17,posY*0.993,sX*0.018,sY*0.029,"files/img/error.png",0,0,0,tocolor(255,255,255,alpha*0.85));
				elseif mData[2] == "warning" then
				dxDrawImage(posX+mData[4]-17,posY*0.993,sX*0.018,sY*0.029,"files/img/warning.png",0,0,0,tocolor(255,255,255,alpha*0.85));
				elseif mData[2] == "info" then
				dxDrawImage(posX+mData[4]-17,posY*0.993,sX*0.018,sY*0.029,"files/img/info.png",0,0,0,tocolor(255,255,255,alpha*0.85));
				elseif mData[2] == "success" then
				dxDrawImage(posX+mData[4]-17,posY*0.993,sX*0.018,sY*0.029,"files/img/succes.png",0,0,0,tocolor(255,255,255,alpha*0.85));
				end
				dxDrawText(mData[1],posX,posY,posX+mData[4],posY+sY*0.025,tocolor(255,255,255,255),0.7, DxData.font, 'center', 'center', true, false, true, true);
			end
			i = i + 1

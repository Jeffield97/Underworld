...
--SKIN REPLACEMENTS
	--------------------------------------
    txd = engineLoadTXD("skins/Zombie1.txd", 307 )
  engineImportTXD(txd, 307)
  dff = engineLoadDFF("skins/Zombie1.dff", 307 )
  engineReplaceModel(dff, 307)
  --------------------------------------
    txd = engineLoadTXD("skins/Zombie2.txd", 308 )
  engineImportTXD(txd, 308)
  dff = engineLoadDFF("skins/Zombie2.dff", 308 )
  engineReplaceModel(dff, 308)
  --------------------------------------
    txd = engineLoadTXD("skins/Zombie3.txd", 309 )
  engineImportTXD(txd, 309)
  dff = engineLoadDFF("skins/Zombie3.dff", 309 )
  engineReplaceModel(dff, 309)
  --------------------------------------
    txd = engineLoadTXD("skins/Zombie4.txd", 310 )
  engineImportTXD(txd, 310)
  dff = engineLoadDFF("skins/Zombie4.dff", 310 )
  engineReplaceModel(dff, 310)
  ----------------------------------------
    txd = engineLoadTXD("skins/Zombie5.txd",311 )
  engineImportTXD(txd, 311)
  dff = engineLoadDFF("skins/Zombie5.dff",311 )
  engineReplaceModel(dff, 311)
  -- --------------------------------------
    txd = engineLoadTXD("skins/Zombie6.txd",312 )
  engineImportTXD(txd, 312)
  dff = engineLoadDFF("skins/Zombie6.dff",312 )
  engineReplaceModel(dff, 312)
  -- --------------------------------------
    txd = engineLoadTXD("skins/Zombie7.txd", 278 )
  engineImportTXD(txd, 278)
  dff = engineLoadDFF("skins/Zombie7.dff", 278 )

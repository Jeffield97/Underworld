...
GUIEditor = {
    label = {}
        ...
        Create_Group_Button = guiCreateButton(226, 56, 102, 37, "Crear Clan", false, Groups_Window)
        guiSetProperty(Create_Group_Button, "NormalTextColour", "FF02F5E1")
        GUIEditor.label[1] = guiCreateLabel(75, 30, 110, 16, "Crear Clan:", false, Groups_Window)
        ...
        Members_Group_Button = guiCreateButton(9, 145, 217, 36, "Ver miembros", false, Groups_Window)
        guiSetFont(Members_Group_Button, "default-bold-small")
        guiSetProperty(Members_Group_Button, "NormalTextColour", "FF3bf9bf")
        myInvites_Group_Button = guiCreateButton(9, 221, 217, 36, "Ver mis invitaciones", false, Groups_Window)
        guiSetFont(myInvites_Group_Button, "default-bold-small")
        guiSetProperty(myInvites_Group_Button, "NormalTextColour", "FF3bf9bf")
        -- InfoEdit_Group_Button = guiCreateButton(9, 294, 217, 36, "View/Edit My Group Info", false, Groups_Window)
        InfoEdit_Group_Button = guiCreateButton(9, 294, 217, 36, "Ver/Editar información", false, Groups_Window)
        guiSetFont(InfoEdit_Group_Button, "default-bold-small")
        guiSetProperty(InfoEdit_Group_Button, "NormalTextColour", "FF3bf9bf")
        -- Leave_Group_Button = guiCreateButton(246, 145, 86, 41, "Leave Group", false, Groups_Window)
        Leave_Group_Button = guiCreateButton(246, 145, 86, 41, "Abandonar clan", false, Groups_Window)
        ...
        GroupList_Group_Button = guiCreateButton(246, 221, 86, 41, "Lista de clanes", false, Groups_Window)
        guiSetFont(GroupList_Group_Button, "default-bold-small")
        guiSetProperty(GroupList_Group_Button, "NormalTextColour", "FF3bf9bf")
        Close_Group_Button = guiCreateButton(246, 294, 86, 41, "Cerrar", false, Groups_Window)
        guiSetFont(Close_Group_Button, "default-bold-small")
        guiSetProperty(Close_Group_Button, "NormalTextColour", "FFFF0000")
        GUIEditor.label[4] = guiCreateLabel(98, 366, 154, 15, "Administración del clan:", false, Groups_Window)
        guiSetFont(GUIEditor.label[4], "default-bold-small")
        InvitesPlayer_Group_Button = guiCreateButton(9, 391, 149, 30, "Invitar Jugador", false, Groups_Window)
        guiSetFont(InvitesPlayer_Group_Button, "default-bold-small")
        guiSetProperty(InvitesPlayer_Group_Button, "NormalTextColour", "FFC0C0C0")
        Group_History_Button = guiCreateButton(179, 391, 149, 30, "Historial del clan", false, Groups_Window)
        guiSetFont(Group_History_Button, "default-bold-small")
        guiSetProperty(Group_History_Button, "NormalTextColour", "FFC0C0C0")
        -- Group_Rank_Button = guiCreateButton(9, 431, 149, 30, "Manage Group Rank", false, Groups_Window)
        Group_Rank_Button = guiCreateButton(9, 431, 149, 30, "Gestionar Rangos", false, Groups_Window)
        guiSetFont(Group_Rank_Button, "default-bold-small")
        guiSetProperty(Group_Rank_Button, "NormalTextColour", "FFC0C0C0")
        Group_Bank_Button = guiCreateButton(179, 431, 149, 30, "Banco del clan", false, Groups_Window)
        guiSetFont(Group_Bank_Button, "default-bold-small")
        guiSetProperty(Group_Bank_Button, "NormalTextColour", "FFC0C0C0")
        Group_TopTurf_Button = guiCreateButton(9, 471, 149, 30, "Top Turf Clanes", false, Groups_Window)
        guiSetFont(Group_TopTurf_Button, "default-bold-small")
        guiSetProperty(Group_TopTurf_Button, "NormalTextColour", "FFC0C0C0")
        Group_TopBank_Button = guiCreateButton(179, 471, 149, 30, "Top Bancos Clanes", false, Groups_Window)
        guiSetFont(Group_TopBank_Button, "default-bold-small")
        guiSetProperty(Group_TopBank_Button, "NormalTextColour", "FFC0C0C0")
        -- Group_BlackList_Button = guiCreateButton(76, 505, 187, 28, "Manage Group Black List", false, Groups_Window)
        Group_BlackList_Button = guiCreateButton(76, 505, 187, 28, "Gestionar lista negra", false, Groups_Window)
        guiSetFont(Group_BlackList_Button, "default-bold-small")
        guiSetProperty(Group_BlackList_Button, "NormalTextColour", "FFC0C0C0")
        -- Admin_Group_Button = guiCreateButton(11, 543, 322, 28, "Delete Group", false, Groups_Window)
        Admin_Group_Button = guiCreateButton(11, 543, 322, 28, "Eliminar Clan", false, Groups_Window)
        guiSetFont(Admin_Group_Button, "default-bold-small")
        guiSetProperty(Admin_Group_Button, "NormalTextColour", "FFFF0000")
        Name_Group_Label = guiCreateLabel(17, 122, 143, 18, "Nombre del clan: No Group", false, Groups_Window)
        myInvites_Group_Label = guiCreateLabel(17, 198, 143, 13, "Invitaciones: 0", false, Groups_Window)
        GUIEditor.label[5] = guiCreateLabel(17, 271, 143, 13, "Información del clan :", false, Groups_Window)
		
function closewin()
guiSetVisible (Groups_Window,false)		
end
addEventHandler ("onClientResourceStart",root,closewin)		
CheckLeaveWindow = guiCreateWindow(x/2-134, y/2-50, 268, 100, "Abandonar clan", false)
...
guiCreateLabel(10, 26, 254, 17, "¿Estás seguro de abandonar el clan?", false, CheckLeaveWindow)

YesLeaveGroup = guiCreateButton(15, 63, 104, 27, "Si", false, CheckLeaveWindow)
...
Group_Rank_Window = guiCreateWindow(x/2-264.5, y/2-152.5, 640, 305, "Gestionador de Rangos", false)
...
guiGridListAddColumn(Group_Rank_Gridlist, "Rango", 0.9)
Group_Rank_Label = guiCreateLabel(309, 24, 98, 15, "Lista de permisos", false, Group_Rank_Window)
guiSetFont(Group_Rank_Label, "default-bold-small")

Group_Rank_Scrollpane = guiCreateScrollPane(221, 46, 400, 200, false, Group_Rank_Window)

Group_Rank_Permission_1 = guiCreateCheckBox(3, 2, 276, 19, "Capaz de degradar a los jugadores.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_2 = guiCreateCheckBox(3, 22, 276, 19, "Capaz de promover jugadores.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_3 = guiCreateCheckBox(3, 42, 276, 19, "Capaz de expulsar miembros.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_4 = guiCreateCheckBox(3, 62, 370, 19, "Capaz de promover jugadores hasta su propio rango.", true, false, Group_Rank_Scrollpane)
Group_Rank_Permission_5 = guiCreateCheckBox(3, 82, 276, 19, "Capaz de editar la información del clan.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_6 = guiCreateCheckBox(3, 102, 276, 19, "Capaz de invitar a los jugadores al clan.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_7 = guiCreateCheckBox(3, 122, 276, 19, "Capaz de eliminar el clan.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_8 = guiCreateCheckBox(3, 142, 276, 19, "Capaz de ver el historial del clan.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_9 = guiCreateCheckBox(3, 162, 370, 19, "Capaz de degradar a jugadores con el mismo rango.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_10 = guiCreateCheckBox(3, 182, 370, 19, "Capaz de depositar dinero en el banco del grupo.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_11 = guiCreateCheckBox(3, 202, 276, 19, "Capaz de retirar dinero del banco del grupo.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_12 = guiCreateCheckBox(3, 222, 276, 19, "Capaz de cambiar el color del turf.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_13 = guiCreateCheckBox(3, 242, 276, 19, "Capaz de cambiar el color del chat.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_14 = guiCreateCheckBox(3, 262, 370, 19, "Capaz de advertir a los miembros del grupo.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_15 = guiCreateCheckBox(3, 282, 370, 19, "Capaz de dar dinero a todos los miembros del grupo.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_16 = guiCreateCheckBox(3, 302, 370, 19, "Capaz de silenciar a los miembros del grupo.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_17 = guiCreateCheckBox(3, 322, 370, 19, "Capaz de dar dinero del banco del grupo a un miembro del clan.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_18 = guiCreateCheckBox(3, 342, 276, 19, "Capaz de eliminar un evento del historial.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_19 = guiCreateCheckBox(3, 362, 276, 19, "Capaz de ver la lista negra del grupo.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_20 = guiCreateCheckBox(3, 382, 276, 19, "Capaz de bloquear una cuenta.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_21 = guiCreateCheckBox(3, 402, 276, 19, "Capaz de bloquear un serial.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_22 = guiCreateCheckBox(3, 422, 276, 19, "Capaz de desbloquear una cuenta.", false, false, Group_Rank_Scrollpane)
Group_Rank_Permission_23 = guiCreateCheckBox(3, 442, 276, 19, "Capaz de desbloquear un serial.", false, false, Group_Rank_Scrollpane)
...
Group_EditRank = guiCreateButton(11, 266, 119, 29, "Editar Rango", false, Group_Rank_Window)
Group_RemoveRank = guiCreateButton(140, 266, 119, 29, "Eliminar Rango", false, Group_Rank_Window)
Group_AddNewRank = guiCreateButton(264, 266, 119, 29, "Agregar Rango", false, Group_Rank_Window)
Group_CloseRankWindow = guiCreateButton(393, 266, 119, 29, "Cerrar", false, Group_Rank_Window)

Add_Rank_Window = guiCreateWindow(x/2-157.5, y/2-165, 450, 330, "Agregar Rango", false)
guiWindowSetSizable(Add_Rank_Window, false)
guiSetAlpha(Add_Rank_Window, 1)
guiSetVisible(Add_Rank_Window, false)

Add_RankName_Label = guiCreateLabel(10, 27, 88, 15, "Rango", false, Add_Rank_Window)
...
Add_RankAfter_Label = guiCreateLabel(10, 55, 150, 15, "Añadir después de:", false, Add_Rank_Window)
guiSetFont(Add_RankAfter_Label, "default-bold-small")
AddRankComboBox = guiCreateComboBox(120, 53, 180, 120, "Escoger rango", false, Add_Rank_Window)
Add_Rank_Scrollpane = guiCreateScrollPane(10, 78, 450, 200, false, Add_Rank_Window)
Add_Rank_Permission_1 = guiCreateCheckBox(3, 2, 276, 19, "Capaz de degradar a los jugadores.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_2 = guiCreateCheckBox(3, 22, 276, 19, "Capaz de promover jugadores.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_3 = guiCreateCheckBox(3, 42, 276, 19, "Capaz de expulsar miembros.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_4 = guiCreateCheckBox(3, 62, 376, 19, "Capaz de promover jugadores hasta su propio rango.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_5 = guiCreateCheckBox(3, 82, 376, 19, "Capaz de editar la información del clan.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_6 = guiCreateCheckBox(3, 102, 376, 19, "Capaz de invitar a los jugadores al clan.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_7 = guiCreateCheckBox(3, 122, 276, 19, "Capaz de eliminar el clan.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_8 = guiCreateCheckBox(3, 142, 276, 19, "Capaz de ver el historial del clan.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_9 = guiCreateCheckBox(3, 162, 376, 19, "Capaz de degradar a jugadores con el mismo rango.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_10 = guiCreateCheckBox(3, 182, 376, 19, "Capaz de depositar dinero en el banco del grupo.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_11 = guiCreateCheckBox(3, 202, 276, 19, "Capaz de retirar dinero del banco del grupo.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_12 = guiCreateCheckBox(3, 222, 276, 19, "Capaz de cambiar el color del turf.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_13 = guiCreateCheckBox(3, 242, 276, 19, "Capaz de cambiar el color del chat.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_14 = guiCreateCheckBox(3, 262, 276, 19, "Capaz de advertir a los miembros del grupo.", true, false, Add_Rank_Scrollpane)
Add_Rank_Permission_15 = guiCreateCheckBox(3, 282, 376, 19, "Capaz de dar dinero a todos los miembros del grupo.", false, false, Add_Rank_Scrollpane)
Add_Rank_Permission_16 = guiCreateCheckBox(3, 302, 276, 19, "Capaz de silenciar a los miembros del grupo.", false, false, Add_Rank_Scrollpane)
Add_Rank_Permission_17 = guiCreateCheckBox(3, 322, 376, 19, "Capaz de dar dinero del banco del grupo a un miembro del clan.", false, false, Add_Rank_Scrollpane)
Add_Rank_Permission_18 = guiCreateCheckBox(3, 342, 276, 19, "Capaz de eliminar un evento del historial.", false, false, Add_Rank_Scrollpane)
Add_Rank_Permission_19 = guiCreateCheckBox(3, 362, 276, 19, "Capaz de ver la lista negra del grupo.", false, false, Add_Rank_Scrollpane)
Add_Rank_Permission_20 = guiCreateCheckBox(3, 382, 276, 19, "Capaz de bloquear una cuenta.", false, false, Add_Rank_Scrollpane)
Add_Rank_Permission_21 = guiCreateCheckBox(3, 402, 276, 19, "Capaz de bloquear un serial.", false, false, Add_Rank_Scrollpane)
Add_Rank_Permission_22 = guiCreateCheckBox(3, 422, 276, 19, "Capaz de desbloquear una cuenta.", false, false, Add_Rank_Scrollpane)
Add_Rank_Permission_23 = guiCreateCheckBox(3, 442, 276, 19, "Capaz de desbloquear un serial.", false, false, Add_Rank_Scrollpane)

Add_NewRank = guiCreateButton(11, 288, 139, 29, "Agregar Rango", false, Add_Rank_Window)
Add_Cancel = guiCreateButton(340, 288, 139, 29, "Cancelar", false, Add_Rank_Window)

Edit_Rank_Window = guiCreateWindow(x/2-153.5, y/2-165, 315, 307, "Editar Rango", false)
guiWindowSetSizable(Edit_Rank_Window, false)
guiSetAlpha(Edit_Rank_Window, 1)
guiSetVisible(Edit_Rank_Window, false)

Edit_RankName_Label = guiCreateLabel(10, 27, 88, 15, "Rango", false, Edit_Rank_Window)
...
Edit_Rank_Permission_1 = guiCreateCheckBox(3, 2, 276, 19, "Capaz de degradar a los jugadores.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_2 = guiCreateCheckBox(3, 22, 276, 19, "Capaz de promover jugadores.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_3 = guiCreateCheckBox(3, 42, 276, 19, "Capaz de expulsar miembros.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_4 = guiCreateCheckBox(3, 62, 276, 19, "Capaz de promover jugadores hasta su propio rango.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_5 = guiCreateCheckBox(3, 82, 276, 19, "Capaz de editar la información del clan.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_6 = guiCreateCheckBox(3, 102, 276, 19, "Capaz de invitar a los jugadores al clan.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_7 = guiCreateCheckBox(3, 122, 276, 19, "Capaz de eliminar el clan.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_8 = guiCreateCheckBox(3, 142, 276, 19, "Capaz de ver el historial del clan.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_9 = guiCreateCheckBox(3, 162, 276, 19, "Capaz de degradar a jugadores con el mismo rango.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_10 = guiCreateCheckBox(3, 182, 276, 19, "Capaz de depositar dinero en el banco del grupo.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_11 = guiCreateCheckBox(3, 202, 276, 19, "Capaz de retirar dinero del banco del grupo.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_12 = guiCreateCheckBox(3, 222, 276, 19, "Capaz de cambiar el color del turf.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_13 = guiCreateCheckBox(3, 242, 276, 19, "Capaz de cambiar el color del chat.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_14 = guiCreateCheckBox(3, 262, 276, 19, "Capaz de advertir a los miembros del grupo.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_15 = guiCreateCheckBox(3, 282, 276, 19, "Capaz de dar dinero a todos los miembros del grupo .", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_16 = guiCreateCheckBox(3, 302, 276, 19, "Capaz de silenciar a los miembros del grupo.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_17 = guiCreateCheckBox(3, 322, 276, 19, "Capaz de dar dinero del banco del grupo a un miembro del clan.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_18 = guiCreateCheckBox(3, 342, 276, 19, "Capaz de eliminar un evento del historial.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_19 = guiCreateCheckBox(3, 362, 276, 19, "Capaz de ver la lista negra del grupo.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_20 = guiCreateCheckBox(3, 382, 276, 19, "Capaz de bloquear una cuenta.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_21 = guiCreateCheckBox(3, 402, 276, 19, "Capaz de bloquear un serial.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_22 = guiCreateCheckBox(3, 422, 276, 19, "Capaz de desbloquear una cuenta.", true, false, Edit_Rank_Scrollpane)
Edit_Rank_Permission_23 = guiCreateCheckBox(3, 442, 276, 19, "Capaz de desbloquear un serial.", true, false, Edit_Rank_Scrollpane)

Edit_Rank = guiCreateButton(11, 265, 139, 29, "Guardar Rango", false, Edit_Rank_Window)
Edit_Cancel = guiCreateButton(170, 265, 139, 29, "Cancelar", false, Edit_Rank_Window)

CheckRemoveRankWindow = guiCreateWindow(x/2-134, y/2-63.5, 268, 127, "Eliminar Rango", false)
...
guiCreateLabel(10, 26, 254, 17, "¿Estás seguro de eliminar este rango?", false, CheckRemoveRankWindow)
-- guiCreateLabel(14, 43, 244, 17, "People in this rank will be auto demoted to", false, CheckRemoveRankWindow)
guiCreateLabel(14, 43, 244, 17, "Los miembros bajarán al rango inferior", false, CheckRemoveRankWindow)
-- guiCreateLabel(83, 60, 108, 15, "the previous rank", false, CheckRemoveRankWindow)
-- guiCreateLabel(83, 60, 108, 15, "rango inferior", false, CheckRemoveRankWindow)

YesRemoveRank = guiCreateButton(15, 90, 104, 27, "Si", false, CheckRemoveRankWindow)
...
Group_Info_Window = guiCreateWindow(x/2-252,y/2-203,505,406,"Información del clan",false)
Group_Info_ButtonSave = guiCreateButton(315,368,95,29,"Guardar",false,Group_Info_Window)
...
Max_Info_Label = guiCreateLabel(10,377,250,30,"(8001) Caracteres restantes",false,Group_Info_Window)

addEventHandler("onClientGUIChanged", resourceRoot,
function()
	if source == Group_Info_Memo then
		local cT = guiGetText(Group_Info_Memo)
		guiSetText(Max_Info_Label, "("..8001-#cT..") Caracteres restantes.")
	elseif source == ViewGroup_Info_Memo then
		local cT = guiGetText(ViewGroup_Info_Memo)
		guiSetText(Max_Info_LabelM, "("..8001-#cT..") Caracteres restantes.")
...
function setButtonStat()
	if getElementData(localPlayer, "Group") then
		guiSetText(Name_Group_Label,"Clan: "..getElementData(localPlayer, "Group"))
		...
		guiSetText(Name_Group_Label,"Clan: N/A")
...
function on_Group_Click()
	...
	elseif source == Leave_Group_Button then
		if getElementData(localPlayer,"Group") then
			...
			guiSetText(CheckLeaveWindow, "Abandonar Clan '"..getElementData(localPlayer, "Group").."'")
		end
...
function(groups)
	...
	guiSetText(Total_Groups, "Clanes Totales: "..GroupTotal)
	guiSetText(Total_Groups_Members, "Miembros totales: "..MemberTotal)
end)
...
function(Invite)
	...
	guiSetText(myInvites_Group_Label, "Invitaciones: "..invCont)
end)
...
guiGridListAddColumn(Group_TopKill_Points, "Puntos", 0.3)
Group_TopKill_Close = guiCreateButton(113, 411, 114, 24, "Cerrar", false, Group_TopKill_Window) 

Group_TopBank_Window = guiCreateWindow(x/2-185,y/2-225, 341, 445, "Top Bancos", false)
...
guiGridListAddColumn(Group_TopBank_List, "Dinero", 0.3)
Group_TopBank_Close = guiCreateButton(113, 411, 114, 24, "Cerrar", false, Group_TopBank_Window) 
...
guiGridListAddColumn(Group_TopTurf_Points, "Puntos", 0.3)
Group_TopTurf_Close = guiCreateButton(113, 411, 114, 24, "Cerrar", false, Group_TopTurf_Window) 

Group_List_Window = guiCreateWindow(x/2-185,y/2-225,370,440,"Lista De Clanes",false)
...
guiGridListAddColumn(Group_List_Grid,"Miembros",0.30)
guiGridListAddColumn(Group_List_Grid,"Creado por",0.45)

guiSetVisible(Group_List_Window, false)
Total_Groups = guiCreateLabel(20,385,191,17,"Clanes totales: 0",false,Group_List_Window)
Total_Groups_Members = guiCreateLabel(230,385,191,17,"Miembros totales: 0",false,Group_List_Window)
Group_List_Button = guiCreateButton(150,408,68,25,"Cerrar",false,Group_List_Window)
Group_Invite_Window = guiCreateWindow(x/2-140,y/2-201,280,402,"Invitar Jugador",false)
...
Group_Invite_Label1 = guiCreateLabel(41,313,191,17,"Solo personas que aún no están en un grupo",false,Group_Invite_Window)
Group_Invite_Label2 = guiCreateLabel(41,335,158,20,"puede ser invitado a unirse.",false,Group_Invite_Window)
Group_Invite_Button = guiCreateButton(11,367,101,24,"Invitar jugador",false,Group_Invite_Window)
Group_Invite_Close = guiCreateButton(166,367,99,24,"Cerrar",false,Group_Invite_Window)
...
myGroup_Invite_Window = guiCreateWindow(x/2-259,y/2-124,518,248,"Invitar Jugador",false)
...
guiGridListAddColumn(myGroup_Invite_Grid,"Invitacion de",0.4)
-- guiGridListAddColumn(myGroup_Invite_Grid,"Name of the person who invited you",0.55)
guiGridListAddColumn(myGroup_Invite_Grid,"Nombre del jugador quien te invitó",0.55)
Accept_Group_Invite_Button = guiCreateButton(20,200,150,32,"Aceptar Invitación",false,myGroup_Invite_Window)
Reject_Group_Invite_Button = guiCreateButton(175,200,150,32,"Rechazar Invitación",false,myGroup_Invite_Window)
Close_Group_Invite_Button = guiCreateButton(390,200,105,32,"Cerrar",false,myGroup_Invite_Window)

Group_Leader_Window = guiCreateWindow(x/2-155,y/2-100,313,245,"Eliminar Clan",false)
guiSetAlpha(Group_Leader_Window,1)
guiSetVisible(Group_Leader_Window, false)
guiWindowSetSizable(Group_Leader_Window,false)

Group_Leader_Label1 = guiCreateLabel(12,26,293,14,"La eliminación del clan es permanente.",false,Group_Leader_Window)
...
Group_Leader_Label2 = guiCreateLabel(8,65,160,16,"Confirmar el nombre del clan:",false,Group_Leader_Window)
Group_Leader_Label3 = guiCreateLabel(8,107,160,16,"Confirmar tu cuenta:",false,Group_Leader_Window)
Group_Leader_Label4 = guiCreateLabel(8,145,148,16,"Confirmar contraseña:",false,Group_Leader_Window)
Group_Leader_Label5 = guiCreateLabel(11,206,44,13,"Verificar",false,Group_Leader_Window)
-- Group_Leader_Label6 = guiCreateLabel(11,221,54,13,"para eliminar",false,Group_Leader_Window)
Group_Leader_Checkbox = guiCreateCheckBox(63,208,15,16,"",false,false,Group_Leader_Window)
Group_Leader_Delete = guiCreateButton(92,205,119,28,"Eliminar Clan",false,Group_Leader_Window)
Group_Leader_Close = guiCreateButton(233,205,71,28,"Cancelar",false,Group_Leader_Window)
...
MyGroup_Members_Window = guiCreateWindow(x/2-291, y/2-250, 642, 546,"Miembros del clan",false)--x/2-291, y/2-212, 642, 502
...
guiGridListAddColumn(MyGroup_Members_Grid,"Nombre",0.3)
guiGridListAddColumn(MyGroup_Members_Grid,"Cuenta",0.23)
guiGridListAddColumn(MyGroup_Members_Grid,"Rango",0.15)
guiGridListAddColumn(MyGroup_Members_Grid,"Última conexión",0.15)
guiGridListAddColumn(MyGroup_Members_Grid,"Advertencia",0.1)
...
ALabel = guiCreateLabel(41, 431, 86, 15, "Color de Turf :", false, MyGroup_Members_Window) 
SetTurfColor = guiCreateButton(436, 428, 108, 24, "Establecer Color", false, MyGroup_Members_Window) 

TAPLLABEL = guiCreateLabel(41, 462, 86, 15, "Color de Chat :", false, MyGroup_Members_Window) --Chat
...
SetChatColor = guiCreateButton(436, 457, 108, 24, "Establecer Color", false, MyGroup_Members_Window) 

Alabeltag = guiCreateLabel(41, 491, 88, 15, "Color del Tag :", false, MyGroup_Members_Window) --Tag
...
setTagColor = guiCreateButton(436, 488, 108, 24, "Establecer Color", false, MyGroup_Members_Window)       
...
--------------------------------------------
Promote_Button = guiCreateButton(19, 374, 120, 32, "Promover", false, MyGroup_Members_Window)
Demote_Button = guiCreateButton(150, 374, 120, 32, "Degradar", false, MyGroup_Members_Window)
WL_Button = guiCreateButton(281, 374, 135, 32, "Advertir", false, MyGroup_Members_Window)
Mute_Button = guiCreateButton(426, 373, 118, 33, "Mutear / Desmutear", false, MyGroup_Members_Window)    
BlipCheck = guiCreateCheckBox(41, 521, 268, 15, "Marcar Miembros", false, false, MyGroup_Members_Window)    

MyGroup_Members_Close = guiCreateButton(554, 373, 75, 32, "Cerrar", false, MyGroup_Members_Window)
...
Promote_Demote_Combobox = guiCreateComboBox(15, 22, 228, 120, "Escoger un rango", false, Promote_Demote_Window)
...
Promote_Demote_Rank = guiCreateLabel(22, 100, 141, 19, "Rango Actual: Trial", false, Promote_Demote_Window)
Promote_Demote_Reason = guiCreateLabel(82, 125, 95, 19, "Razón (Opcional):", false, Promote_Demote_Window)
...
Promote_Demote_Cancel = guiCreateButton(137, 188, 112, 30, "Cancelar", false, Promote_Demote_Window)
...
guiCreateLabel(114, 28, 109, 19, "Nuevo nivel de advertencia", false, Warn_Window)
Warn_Bar = guiCreateProgressBar(10, 50, 255, 23, false, Warn_Window)
Warn_Edit = guiCreateEdit(270, 50, 45, 23, "", false, Warn_Window)
guiCreateLabel(114, 83, 109, 19, "Razón (Opcional)", false, Warn_Window)
Warn_Reason_Edit = guiCreateEdit(9, 108, 304, 24, "", false, Warn_Window)
SetWarn_Button = guiCreateButton(10, 141, 141, 33, "Advertir", false, Warn_Window)
CancelWarn_Button = guiCreateButton(177, 141, 141, 33, "Cancelar", false, Warn_Window)
...
GroupBank_Window = guiCreateWindow(x/2-126,y/2-92, 252, 261, "Banco del clan", false)
guiWindowSetSizable(GroupBank_Window, false)
guiSetVisible(GroupBank_Window, false)
guiSetAlpha(GroupBank_Window,1)

GroupBank_Balance_Lable = guiCreateLabel(36, 23, 204, 17, "Dinero del banco: $0", false, GroupBank_Window)
...
GroupBank_Deposit_Button = guiCreateButton(138, 50, 105, 22, "Depositar", false, GroupBank_Window)
GroupBank_Withdraw_Button = guiCreateButton(138, 82, 105, 22, "Retirar", false, GroupBank_Window)
GroupBank_GiveAll_Button = guiCreateButton(138, 113, 105, 22, "Dar dinero a todos", false, GroupBank_Window)
GroupBank_GiveMember_Button = guiCreateButton(175, 141, 67, 27,"Dar dinero", false, GroupBank_Window)
GroupBank_GiveMember_Combmo = guiCreateComboBox ( 71, 140, 103, 73, "Miembro", false, GroupBank_Window)
GroupBank_Close = guiCreateButton(9, 186, 230, 27, "Cerrar", false, GroupBank_Window)
GroupBank_dLable = guiCreateLabel(8, 219, 231, 32, "Los detalles como quién depositó el dinero se pueden ver en el historial del grupo.", false, GroupBank_Window)
...
Group_History_Window = guiCreateWindow(x/2-291, y/2-250, 667, 503, "Historial del clan", false)
...
guiGridListAddColumn(Group_History_Log,"Fecha",0.20)
guiGridListAddColumn(Group_History_Log,"Evento",0.74)

GroupHistory_Button_Close = guiCreateButton(506, 432, 151, 51, "Cerrar", false, Group_History_Window)
GroupHistory_Button_DeleteLog = guiCreateButton(10, 432, 151, 51, "Eliminar Evento", false, Group_History_Window)
...
Group_BlackList_Window = guiCreateWindow(x/2-350,y/2-200, 668, 396, "Lista negra del clan", false)
...
Group_BlackList_Accounts = guiCreateTab("Cuentas", Group_BlackList_TabPanel)

Group_BlackList_AccountsList = guiCreateGridList(5, 10, 634, 246, false, Group_BlackList_Accounts)
guiGridListAddColumn(Group_BlackList_AccountsList, "Responsable", 0.2)
guiGridListAddColumn(Group_BlackList_AccountsList, "Cuenta bloqueada", 0.2)
guiGridListAddColumn(Group_BlackList_AccountsList, "Razón", 0.2)
guiGridListAddColumn(Group_BlackList_AccountsList, "Fecha", 0.2)
Group_BlackList_AccountRemove = guiCreateButton(5, 262, 209, 32, "Eliminar Seleccionada", false, Group_BlackList_Accounts)
Group_BlackList_AccountAdd = guiCreateButton(241, 262, 209, 32, "Agregar Cuenta", false, Group_BlackList_Accounts)

Group_BlackList_Serials = guiCreateTab("Seriales", Group_BlackList_TabPanel)
		
Group_BlackList_SerialsList = guiCreateGridList(5, 10, 634, 246, false, Group_BlackList_Serials)
guiGridListAddColumn(Group_BlackList_SerialsList, "Responsable", 0.2)
guiGridListAddColumn(Group_BlackList_SerialsList, "Serial Bloqueado", 0.4)
guiGridListAddColumn(Group_BlackList_SerialsList, "Razón", 0.2)
guiGridListAddColumn(Group_BlackList_SerialsList, "Fecha", 0.2)
Group_BlackList_SerialRemove = guiCreateButton(5, 262, 209, 32, "Eliminar Seleccionada", false, Group_BlackList_Serials)
Group_BlackList_SerialAdd = guiCreateButton(241, 262, 209, 32, "Agregar Serial", false, Group_BlackList_Serials)
Group_BlackList_Close = guiCreateButton(510, 356, 148, 30, "Cerrar", false, Group_BlackList_Window) 

Group_BlackList_Block_Window = guiCreateWindow(x/2-150,y/2-140, 347, 236, "Bloquear Cuenta", false)
guiWindowSetSizable(Group_BlackList_Block_Window, false)
guiSetVisible(Group_BlackList_Block_Window, false)
guiSetAlpha (Group_BlackList_Block_Window,1)

Group_BlackAccount_Edit = guiCreateEdit(9, 29, 316, 39, "Cuenta", false, Group_BlackList_Block_Window)
Group_BlackReason_Edit = guiCreateEdit(9, 105, 316, 39, "Razón", false, Group_BlackList_Block_Window)
Group_BlackBlock_Button = guiCreateButton(12, 171, 143, 46, "Bloquear", false, Group_BlackList_Block_Window)
Group_BlackBlock_Close = guiCreateButton(182, 171, 143, 46, "Cancelar", false, Group_BlackList_Block_Window)    

Group_BlackList_Block_Windowserial = guiCreateWindow(x/2-150,y/2-140, 347, 236, "Bloquear Serial", false)
...
Group_BlackReasonserial_Edit = guiCreateEdit(9, 105, 316, 39, "Razón", false, Group_BlackList_Block_Windowserial)
Group_BlackBlockserial_Button = guiCreateButton(12, 171, 143, 46, "Bloquear", false, Group_BlackList_Block_Windowserial)
Group_BlackBlockserial_Close = guiCreateButton(182, 171, 143, 46, "Cancelar", false, Group_BlackList_Block_Windowserial)    

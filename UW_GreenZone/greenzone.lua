...
function(hitElement, matchingDimension)
  if (getElementType (hitElement) == "player") and (getElementID (source) == "greenzoneColshape") then
	...
	outputChatBox("Has entrado a zona segura!",hitElement)
	-- setElementAlpha(hitElement,190)
  end
...
function(leaveElement, matchingDimension)
  if (getElementType (leaveElement) == "player") and (getElementID (source) == "greenzoneColshape") then
	...
	triggerClientEvent (leaveElement, "onLeave", leaveElement)
	outputChatBox("Has salido de zona segura!",leaveElement)

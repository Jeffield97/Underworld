...
-- ID / NOME / LEVEL
		...
		dxDrawText(nivel, widgetsHud.txtLevel["posX"], widgetsHud.txtLevel["posY"], widgetsHud.txtLevel["posW"], widgetsHud.txtLevel["posH"], tocolor(255, 255, 255, 255), 1.00, font, "left", "center", false, false, false, false, false)
...
-- FOME / SEDE / PROCURADO
        local Clan = getElementData(localPlayer,"AirNewSCR_Fome") or "N/A"

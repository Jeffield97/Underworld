...
scoreboardColumns = {
	{ ["name"] = "name", ["width"] = 180, ["friendlyName"] = "Jugador", ["priority"] = 1 },
	{ ["name"] = "ping", ["width"] = 25, ["friendlyName"] = "Ping", ["priority"] = MAX_PRIRORITY_SLOT },
}
...
if showCountries then
	table.insert (scoreboardColumns, { ["name"] = "País", ["width"] = 25, ["friendlyName"] = "País", ["priority"] = MAX_PRIRORITY_SLOT-1, ["isImage"] = true, ["imageW"] = 18, ["imageH"] = 12 })
end
...
function scoreboardResetColumns( forElement )
	...
	if forElement == getRootElement() then
		...
		if result then
			...
			scoreboardAddColumn( "País", 20, "País", 20, true, 12, 8 )
		end
		return result
	else
